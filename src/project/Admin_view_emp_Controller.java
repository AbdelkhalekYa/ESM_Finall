...
public class Admin_view_emp_Controller implements Initializable {
    ...
    @FXML private TableColumn<Employee, String> C_AdminID;
    ...
    @FXML private JFXTextField Text_AID;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        C_ID.setCellValueFactory(new PropertyValueFactory<Employee, String>("emp_id"));
        ...
        C_AdminID.setCellValueFactory(new PropertyValueFactory<Employee, String>("admin_id"));
    ...
    public boolean checkAddInputs() throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        if (Text_Fname == null || Text_LName == null || Text_DOB == null || Text_Email == null || Text_Contact == null
                || Text_WageRate == null || Text_WageType == null || Text_Account == null || Text_AID == null) {
        ...
        if (Text_Fname.getText().isEmpty() || Text_LName.getText().isEmpty() || Text_DOB.getText().isEmpty() || Text_Email.getText().isEmpty()
                ...
                || Text_Account.getText().isEmpty() || Text_AID.getText().isEmpty()) {
            openPopup("Missing Input", "Please fill all the fields.");
            return false;
        }
    ...
    public void handleDeleteButton(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            if (dataList.get(i).getEmp_id().equals(empID)) {
                index = i;
                break;
            }
        }
    ...
    public void handleAddButtonAction(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        if (Text_AID != null) {
            aid = Text_AID.getText();
        }


        Employee emp = new Employee(f_name + " " + l_name, dob, contact, email, acc, w_t, Integer.parseInt(w_r), aid);
        emp.addEmployee();
        dataList.addAll(emp);
        ...
        String msg = "Your account has been successfully registered. " + "You can login anytime to access different features. " +
                "Your Employee ID is " + emp.getEmp_id() + " and password is " + emp.getEmp_id() + ". Change it as quickly as possible for security reasons." +
    ...
    public void goToEmpEdit(String empID) throws IOException {
        ...
        //Get controller of edit scene
          Admin_edit_emp_Controller controller = loader.getController();
