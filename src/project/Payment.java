...
public void inputDetails()                                    //Will input payement details
    {
        ...
        if (method == 1) {
            ...
            System.out.println("Company's Account Number = '01018915613'\nTransfer the amount into the above mentioned account.\nYou will receive a notification upon transaction confirmation.\n ");

        else if (method == 3)
            System.out.println("Company's Vodafone Cash number is = '01018915613'\nTransfer the amount into the above mentioned account.\nYou will receive a notification upon transaction confirmation.\n");

        else if (method == 4)
            System.out.println("Company's Fawry number is = '01018915613'\nTransfer the amount into the above mentioned account.\nYou will receive a notification upon transaction confirmation.\n");
