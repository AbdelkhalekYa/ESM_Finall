...
public class Customer {
        ...
        public Customer(String name, int age, String contact_info, String email_address, String account_number, int priority_status)
        {
            this.name = name;
            this.age = age;
        ...
        // Filling project.Customer object from db
