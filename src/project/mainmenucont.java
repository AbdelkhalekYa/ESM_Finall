...
public class mainmenucont {
    ...
    public void gotoSPSignIn() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SP_Signint.fxml"));
        Parent root = loader.load();

        //Get controller of admin ign in scene
        /*sp_signin_controller controller = loader.getController();
        controller.enableSP_btn();*/

        // close current window
        Stage window = (Stage) SP_btn.getScene().getWindow();
        window.close();
    ...
    // open popup
    public void popup(String head, String text) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        //Load next
        ...
        controller.setContent(head,text);
    ...
    public void handlePrivacyButton(ActionEvent actionEvent) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        popup("Privacy Policy", "Privacy Policy\n" +
                ...
                "\n" +
                "Website refers to FCAIH Event Planners\n" +
                "\n" +
