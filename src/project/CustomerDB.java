    ...
    public void insertCustomer()
    {
        ...
        )
        {
            if (conn != null) {
                ...
                query = "insert into customer(CUST_ID, name, age, phone_no, email, ACCOUNT_NUMBER, PRIORITY_STATUS)" +
                        "values('" + new_id + "','" + cust.getName() + "'," + Integer.toString(cust.getAge()) + ",'" + cust.getContact_info() +
    ...
    public void insertCustomer(Customer cust, String id)
    {
        ...
        )
        {
            if (conn != null) {
                ...
                String query = "insert into customer(CUST_ID, name, age, phone_no, email, ACCOUNT_NUMBER, PRIORITY_STATUS)" +
                        "values('" + id + "','" + cust.getName() + "'," + Integer.toString(cust.getAge()) + ",'" + cust.getContact_info() +
                        "','" + cust.getEmail_address() + "','" + cust.getAccount_number() + "'," + Integer.toString(cust.getPriority_status()) + ")";
